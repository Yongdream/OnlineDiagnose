...
def plot_accuracies(accuracy_list, folder):  #损失函数图
	...
	plt.savefig(f'plots/{folder}/{folder}-training-graph.png')
	plt.savefig(f'plots/{folder}/{folder}-training-graph.pdf')
	plt.clf()
	# plt.close()
