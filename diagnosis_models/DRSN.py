...
class RSNet(nn.Module):
    def __init__(self, block, num_block, args, out_channel):
        super().__init__()
...
def DRSN_Net(args, out_channel=10):
    return RSNet(BasicBlock, [3, 4, 6, 3], args, out_channel)


def rsnet18(args, out_channel=10):
    """ return a RSNet 18 object
    """
    return RSNet(BasicBlock, [2, 2, 2, 2], args, out_channel)


def rsnet34(args, out_channel=10):
